 ...
 * @group notification
 */
class UpdateCustomNotificationCommandValidationTest extends ValidationTestCase
{
    private $command;
    ...
    protected function setUp(): void
    {
        ...
        $this->command = new UpdateCustomNotificationCommand($this->createMock(CustomNotification::class));
    }
