...
class LoadAdvancedSemanticLinkWithValidUri extends Fixture
{
    public const REFERENCE_NAME = 'advanced-semantic-link-article-with-valid-uri';
    ...
    public function load(ObjectManager $manager): void
    {
        $semanticLink = new SemanticLink(
            Uuid::uuid4(),
            '/articles/view/86281/',
            'black hole hyper отзыв перейти'
        );
