...
class LoadInterestingVideoFromRegion extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'video-interesting-from-region';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $video->rewriteRegion($this->getReference(LoadTestRegion::REFERENCE_NAME));
        $video->updateRatingInfo(new RatingInfo(2, 2, 0, 2));
