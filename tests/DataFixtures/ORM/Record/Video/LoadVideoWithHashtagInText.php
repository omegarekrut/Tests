...
class LoadVideoWithHashtagInText extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'video-with-hashtag-in-text';
    ...
    {
        $text = 'text for video with #hashtag in text';
