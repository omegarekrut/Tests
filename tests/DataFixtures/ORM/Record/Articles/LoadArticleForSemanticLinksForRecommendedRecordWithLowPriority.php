...
class LoadArticleForSemanticLinksForRecommendedRecordWithLowPriority extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'article-with-low-priority';
