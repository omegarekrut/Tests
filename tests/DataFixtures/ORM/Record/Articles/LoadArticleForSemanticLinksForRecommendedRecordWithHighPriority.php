...
class LoadArticleForSemanticLinksForRecommendedRecordWithHighPriority extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'article-with-high-priority';
