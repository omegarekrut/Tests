...
class LoadArticleForSemanticLinksForRecommendedRecordWithMediumPriority extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'article-with-medium-priority';
