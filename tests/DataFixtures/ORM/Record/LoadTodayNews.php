...
class LoadTodayNews extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'today-news';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->persist($todayNews);
        $this->addReference(self::REFERENCE_NAME, $todayNews);
