...
class LoadUserWithHighRating extends UserFixture
{
    public const REFERENCE_NAME = 'user-with-high-rating';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $user = new User(
            'user-with-high-rating',
            'user-with-high-rating@fishingsib.loc',
