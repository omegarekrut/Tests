...
class LoadCommentWithoutUrls extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'comment-without-url';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $comment = new Comment(Uuid::uuid4(), $this->generator->regexify('[A-Za-z0-9]{20}'), 'Comment without links', $record, $author);
