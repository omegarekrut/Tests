...
class LoadCompanyWithExpiredSubscription extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'company-with-expired-subscription';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $companyWithOwner->addSubscription(
            $this->companySubscriptionFactory->createExpiredSubscription()
        );
