...
class LoadCompanyWithIrkutskRegion extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'company-with-irkutsk-region';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $location = new Location(Uuid::uuid4(), new Coordinates(52.2977, 104.29639));
