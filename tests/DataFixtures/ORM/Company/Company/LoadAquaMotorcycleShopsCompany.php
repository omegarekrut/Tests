...
class LoadAquaMotorcycleShopsCompany extends Fixture implements DependentFixtureInterface
{
    /** @deprecated Use {@link getReferenceName} */
    public const REFERENCE_NAME = 'aqua-motorcycle-shops-company';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $company->rewriteVideos(new YoutubeVideoUrlCollection(['https://www.youtube.com/watch?v=-964sSBviK0&ab_channel=Jamie%27sDesign']));
    ...
    {
        $name = 'Мототехника и катера для рыбалки';
