...
class LoadCompanyWithSubscriber extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'company-with-subscriber';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $company->setOwner($userWhoWillOwnCompany);
