...
use Tests\DataFixtures\ORM\Company\Company\LoadCompanyWithoutOwnerToFutureRejectOwnershipRequest;
use Tests\DataFixtures\ORM\SingleReferenceFixtureInterface;
use Tests\DataFixtures\ORM\User\LoadNumberedUsers;

class LoadOwnershipRequestToFutureReject extends Fixture implements SingleReferenceFixtureInterface, DependentFixtureInterface
{
    /** @deprecated Use {@link getReferenceName} */
    public const REFERENCE_NAME = 'ownership-request-to-future-reject';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        /** @var Company $company */
        $company = $this->getReference(LoadCompanyWithoutOwnerToFutureRejectOwnershipRequest::REFERENCE_NAME);
    ...
    public function getDependencies(): array
    {
        return [
            ...
            LoadCompanyWithoutOwnerToFutureRejectOwnershipRequest::class,
        ];
    }
}
