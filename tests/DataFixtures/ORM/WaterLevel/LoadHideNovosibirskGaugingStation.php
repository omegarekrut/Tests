...
class LoadHideNovosibirskGaugingStation extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'novosibirsk-hide';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $coordinates = new Coordinates(55.037436, 82.928086);
        $geographicalPosition = new GeographicalPosition($coordinates, 115, 112, 111);

        $id = Uuid::uuid4();
        $name = 'Новосибирск-скрыт';
