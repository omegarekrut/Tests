...
class LoadNovosibirskGaugingStation extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'novosibirsk';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $coordinates = new Coordinates(55.027436, 82.918086);
