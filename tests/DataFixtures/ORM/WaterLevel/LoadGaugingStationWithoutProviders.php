...
class LoadGaugingStationWithoutProviders extends Fixture implements DependentFixtureInterface
{
    public const REFERENCE_NAME = 'gauging-station-without-providers';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $id = Uuid::uuid4();
        $name = 'Гидропост без провайдеров';
