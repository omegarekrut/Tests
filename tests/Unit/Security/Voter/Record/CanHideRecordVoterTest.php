...
use App\Security\Voter\Record\CanHideRecordVoter;
use DateTime;
 ...
 * @group voter
 */
class CanHideRecordVoterTest extends TestCase
{
    private const ATTRIBUTE = 'CAN_HIDE_RECORD';
    ...
    public function testVoteDeniedForRecordOwner(): void
    {
    ...
    public function testVoteAllowForAdministrationRole(): void
    {
    ...
    {
        $voter = new CanHideRecordVoter($this->security);
    ...
    {
        return $this->getMockBuilder(Record::class)->disableOriginalConstructor()->getMock();
    }
