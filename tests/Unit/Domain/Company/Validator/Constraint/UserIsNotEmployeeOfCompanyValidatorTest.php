...
use App\Domain\Company\Validator\Constraint\UserIsNotEmployeeOfCompany;
use App\Domain\Company\Validator\Constraint\UserIsNotEmployeeOfCompanyValidator;
 ...
 * @group company
 */
final class UserIsNotEmployeeOfCompanyValidatorTest extends TestCase
{
    ...
    public function testNullUserLoginOrEmailMustNotCauseErrors(): void
    {
        ...
        $validator = new UserIsNotEmployeeOfCompanyValidator($userRepository, $companyRepository, $this->propertyAccessor);
        $validator->initialize($executionContext);

        $validator->validate(null, new UserIsNotEmployeeOfCompany());
    ...
    public function testNotExistsUserMustNotCauseErrors(): void
    {
        ...
        $validator->validate('user login or email', new UserIsNotEmployeeOfCompany());
        $this->assertFalse($executionContext->hasViolations());
    }
    ...
    public function testUserWhichIsNotEmployeeOfCompanyMustNotCauseErrors(): void
    {
        $userRepository = $this->createUserRepositoryForFindById($this->createMock(User::class));
        $companyRepository = $this->createCompanyRepositoryForFindById(
    ...
    public function testUserWhichIsAlreadyEmployeeOfCompanyMustCauseErrors(): void
    {
        $userRepository = $this->createUserRepositoryForFindById($this->createMock(User::class));
        $companyRepository = $this->createCompanyRepositoryForFindById(
            $this->createConfiguredMock(Company::class, [
    ...
    public function testUnsupportedConstraint(): void
    {
        ...
        $validator = new UserIsNotEmployeeOfCompanyValidator(
